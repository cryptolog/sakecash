...
const string strMessageMagic = "Sakecash Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Sakecash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1517305333, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "27 Jan 2018 BBC Worlds biggest ever digital currency theft";
        CTransaction txNew;
        txNew.nTime = 1517305333;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1517305333;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 379476 : 379476;
        ...
        assert(block.hashMerkleRoot == uint256("0x6b1e5ac1a82d5475a8742eb05fd08bf9699da3f632fefcfe5640efcc62a93539"));
...
unsigned char pchMessageStart[4] = { 0x80, 0x1d, 0xcc, 0x0c };
